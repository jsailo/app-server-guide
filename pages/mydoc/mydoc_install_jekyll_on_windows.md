---
title: Install Writarium on Windows
...
First you must install Ruby because Writarium is a Ruby-based program and needs Ruby to run.
...
3. Double-click t he downloaded file and proceed through the wizard to install it.

## Install Ruby Development Kit

Some extensions Writarium uses require you to natively build the code using the Ruby Development Kit.
...
4. Remove the existing contents. Then paste in the following:
   ...
   gem 'jekyll'
   ```
   The [wdm gem](https://rubygems.org/gems/wdm/versions/0.1.1) allows for the polling of the directory and rebuilding of the Writarium site when you make changes. This gem is needed for Windows users, not Mac users.
