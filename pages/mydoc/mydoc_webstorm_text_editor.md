...
summary: "You can use a variety of text editors when working with a Writarium project. WebStorm from IntelliJ offers a lot of project-specific features, such as find and replace, that make it ideal for working with tech comm projects."
...
Rather than insert the frontmatter by hand each time, it's much faster to simply create a Writarium template. To create a Writarium template in WebStorm:
...
3. Name it something like Writarium page. Insert the frontmatter you want, and save it.

   To use the Writarium template, when you create a new file in your WebStorm project, you can select your Writarium file template.
